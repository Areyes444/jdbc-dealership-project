...
public class DealerShips
{
    public class DealerShips {
        ...
        private int dealerShipsId;
        private String name;
        private String address;
        private String phoneNumber;

        public DealerShips(int dealerShipsId,String name, String address, String phoneNumber)
        {
            this.dealerShipsId = dealerShipsId;
            this.name = name;
            this.address = address;
            this.phoneNumber = phoneNumber;
        }

        public int getDealerShipsId()
        {
            return dealerShipsId;
        }

        public void setDealerShipsId(int dealerShipsId)
        {
            this.dealerShipsId = dealerShipsId;
        }
